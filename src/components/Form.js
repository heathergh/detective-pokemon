    ...
    render() {
        return (
            <>
            {
                ...
                ?   <> 
                        <p className="crime-reminder">You're in <span className="crime-reminder-location">{this.state.userNiceLocationName}</span> solving a case about <span className="normalize-text crime-reminder-crime">{this.state.userNiceCategoryName}</span>.</p>
